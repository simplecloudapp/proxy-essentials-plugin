...
object OldConfigMigrator {
    ...
    private fun disableServerIconForPreviouslyMigratedLayout(source: CommentedConfigurationNode): Boolean {
        ...
        val looksLikePreviouslyMigratedLayout = serverIcon.node("enabled").boolean && serverIcon.node("file").string == "simplecloud.png" && !playerList.node("enabled").boolean && playerList.node("player-list").childrenList().isEmpty()
